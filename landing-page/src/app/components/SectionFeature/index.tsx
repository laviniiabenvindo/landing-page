    ...
    <section className="py-24">
      <GridContainer>
        <div className='text-center mb-16'>
         <small className='block text-brand-700 text-base font-bold mb-3'>Features</small>
         <h2 className='text-center text-4xl text-gray-900 tracking-tight-[-0.72px] font-semibold mb-5'>Analytics that feels like it’s from the future</h2>
        ...
        <div className='grid grid-cols-3 gap-x-8 gap-y-16'>
          <ItemFeature 
          icons={<FiMail size={24} className="text-brand-700"/>}
          ...
          />
          <ItemFeature 
          icons={<FiSmile size={24} className="text-brand-700"/>}
          ...
          />
          <ItemFeature 
          icons={<FiCommand size={24} className="text-brand-700"/>}
          ...
          />
          <ItemFeature 
          icons={<FiMessageCircle size={24} className="text-brand-700"/>}
